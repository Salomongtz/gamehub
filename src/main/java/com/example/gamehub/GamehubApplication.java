...
public class GamehubApplication {
    ...
    public CommandLineRunner initData(CustomerRepository customerRepository, GamesRepository gamesRepository) {
        return args -> {
			...
			Games game = new Games("PUBG", "juegazo", "PUBG", "PUBG", "https://cdn.akamai.steamstatic
			.com/steam/apps/578080/header.jpg?t=1701911655", 1687303L, 0.0, LocalDate.now(), 0.0f, Rating.M, genres,
			platforms);
